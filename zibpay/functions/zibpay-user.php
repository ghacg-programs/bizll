 ...
 * @LastEditTime : 2026-06-17 16:21:00
...
function zib_user_center_page_sidebar_vip($con)
{
    ...
    if ($vip_level) {
        ...
        $button = zib_get_svg('vip_1', '0 0 1024 1024', 'em12 mr6') . __('开通会员 尊享会员权益', 'zib_language');
    }

    $con .= '<div class="mb20 mb10-sm main-radius payvip-icon btn-block badg pointer' . (!$user_id ? ' signin-loader' : '') . '" style="padding: 14px 10px;" data-onclick="[data-target=\'#user-tab-vip\']">' . $button . '<i class="fa fa-chevron-circle-right abs-right"></i></div>';
    return $con;
}
add_filter('user_center_page_sidebar', 'zib_user_center_page_sidebar_vip', 7);
...
function zib_user_center_page_sidebar_balance($con)
{
    ...
    if ($pay_balance_s) {
        ...
        $box .= '<div style="flex: 1;" class="mb10-sm zib-widget padding-10 flex1">
                    <div class="muted-color em09 mb6">' . __('余额', 'zib_language') . '<i class="ml6 fa fa-angle-right em12"></i></div>
    ...
    if ($points_s) {
        ...
        $box .= '<div style="flex: 1;" class="mb10-sm zib-widget padding-10 flex1">
                    <div class="muted-color em09 mb6">' . __('积分', 'zib_language') . '<i class="ml6 fa fa-angle-right em12"></i></div>
...
function zib_user_center_page_sidebar_income_rebate($con)
{
    ...
    if ($pay_income_s) {
        ...
        $box .= '<div style="flex: 1;" class="mb10-sm zib-widget padding-10 flex1 pointer" data-onclick="[data-target=\'#user-tab-income\']">
                    <div class="muted-color em09 mb6 flex ac"><div class="overflow-hidden"><div class="text-ellipsis">' . zib_get_svg('merchant-color', null, 'mr6') . __('创作中心', 'zib_language') . '</div></div><i class="ml6 fa fa-angle-right em12"></i></div>
                    <div class="flex jsa text-center"><div class=""><div class="font-bold em12">' . $c . '</div><div class="px12 opacity5">' . __('商品', 'zib_language') . '</div></div><div class="overflow-hidden"><div class="font-bold em12">' . $b . '</div><div class="px12 opacity5 text-ellipsis">' . $a . '</div></div></div>
                </div>';
    ...
    if ($pay_rebate_s) {
        ...
        $box .= '<div style="flex: 1;" class="mb10-sm zib-widget padding-10 flex1 pointer" data-onclick="[data-target=\'#user-tab-rebate\']">
                    <div class="muted-color em09 mb6 flex ac"><div class="overflow-hidden"><div class="text-ellipsis">' . zib_get_svg('money-color', null, 'mr6') . __('推广中心', 'zib_language') . '</div></div><i class="ml6 fa fa-angle-right em12"></i></div>
                    <div class="flex jsa text-center"><div class=""><div class="font-bold em12">' . $rebate_ratio . '%</div><div class="px12 opacity5">' . __('比例', 'zib_language') . '</div></div><div class="overflow-hidden"><div class="font-bold em12">' . $b . '</div><div class="px12 opacity5 text-ellipsis">' . $a . '</div></div></div>
                </div>';
    }
...
function zibpay_user_page_tabs_array($tabs_array)
{
    ...
    if (_pz('pay_user_vip_1_s') || _pz('pay_user_vip_2_s')) {
        $tabs['vip'] = array(
            'title'    => __('我的会员', 'zib_language'),
            'nav_attr' => 'drawer-title="' . esc_attr(__('我的会员', 'zib_language')) . '"',
    ...
    if (_pz('pay_balance_s') || _pz('points_s')) {
        $tabs['balance'] = array(
            'title'    => __('我的资产', 'zib_language'),
            'nav_attr' => 'drawer-title="' . esc_attr(__('我的资产', 'zib_language')) . '"',
            'loader'   => '<div class="row gutters-10 user-pay"><div class="col-md-6"><div class="zib-widget"><div class="placeholder s1"></div><div class="em3x c-blue">--</div><i class="placeholder s1 mr10"></i><i class="placeholder s1"></i></div></div><div class="col-md-6"><div class="zib-widget"><div class="placeholder s1"></div><div class="em3x c-blue">--</div><i class="placeholder s1 mr10"></i><i class="placeholder s1"></i></div></div></div><div class="box-body notop"><div class="title-theme"><b>' . __('订单明细', 'zib_language') . '</b></div></div>' . str_repeat('<div class="zib-widget"><p class="placeholder k1"></p><p class="placeholder t1"></p><i class="placeholder s1"></i><i class="placeholder s1 ml10"></i></div>', 3),
        );
    }
    ...
    if (_pz('pay_income_s')) {
        $tabs['income'] = array(
            'title'    => __('创作分成', 'zib_language'), //今日收入
            'nav_attr' => 'drawer-title="' . esc_attr(__('创作分成', 'zib_language')) . '"',
            'loader'   => '<div class="row gutters-10 user-pay"><div class="col-md-6"><div class="zib-widget"><div class="placeholder s1"></div><div class="em3x c-blue">--</div><i class="placeholder s1 mr10"></i><i class="placeholder s1"></i></div></div><div class="col-md-6"><div class="zib-widget"><div class="placeholder s1"></div><div class="em3x c-blue">--</div><i class="placeholder s1 mr10"></i><i class="placeholder s1"></i></div></div></div><div class="box-body notop"><div class="title-theme"><b>' . __('订单明细', 'zib_language') . '</b></div></div>' . str_repeat('<div class="zib-widget"><p class="placeholder k1"></p><p class="placeholder t1"></p><i class="placeholder s1"></i><i class="placeholder s1 ml10"></i></div>', 3),
        );
    }
    ...
    if (_pz('pay_rebate_s')) {
        $tabs['rebate'] = array(
            'title'    => __('推广中心', 'zib_language'),
            'nav_attr' => 'drawer-title="' . esc_attr(__('推广中心', 'zib_language')) . '"',
            'loader'   => '<div class="row gutters-10"><div class="col-md-6"><div class="zib-widget jb-red" style="height: 136px;"></div></div>
            <div class="col-md-6"><div style="height: 136px;" class="zib-widget jb-blue"></div></div></div><div class="zib-widget"><div class="box-body"><p class="placeholder k1"></p><p class="placeholder k2"></p><p class="placeholder k1" style="height: 120px;"></p><p class="placeholder t1"></p>
    ...
    if (_pz('pay_show_user')) {
        $tabs['order'] = array(
            'title'    => __('我的订单', 'zib_language'),
            'nav_attr' => 'drawer-title="' . esc_attr(__('我的订单', 'zib_language')) . '"',
            'loader'   => '<div class="row gutters-10 user-pay"><div class="col-md-6"><div class="zib-widget"><div class="placeholder s1"></div><div class="em3x c-blue">--</div><i class="placeholder s1 mr10"></i><i class="placeholder s1"></i></div></div><div class="col-md-6"><div class="zib-widget"><div class="placeholder s1"></div><div class="em3x c-blue">--</div><i class="placeholder s1 mr10"></i><i class="placeholder s1"></i></div></div></div><div class="box-body notop"><div class="title-theme"><b>' . __('订单明细', 'zib_language') . '</b></div></div>' . str_repeat('<div class="zib-widget"><p class="placeholder k1"></p><p class="placeholder t1"></p><i class="placeholder s1"></i><i class="placeholder s1 ml10"></i></div>', 3),
        );
...
{
    $user_id           = get_current_user_id();
    $pay_user_vip_desc = _pz('pay_user_vip_desc');
    $vip_level         = zib_get_user_vip_level($user_id);
    $vip_name          = array(1 => _pz('pay_user_vip_1_name'), 2 => _pz('pay_user_vip_2_name'));
    $avatar            = zib_get_avatar_box($user_id, 'avatar-img avatar-md');
    $name              = zib_get_user_name("id=$user_id&class=flex1 flex ac&follow=false");
    $user_box          = '<div class="flex ac">
        <div class="mr20 shrink0">' . $avatar . '</div>
        <div class="flex1">
            <div class="name em12 font-bold">' . $name . '</div>
            <div class="desc em09  mt6 muted-2-color">' . get_user_desc($user_id) . '</div>
        </div>
    </div>';
    $abs_img = zib_get_svg('vip_1');
    //显示我的会员
    $my_box     = '';
    $my_vip_box = '';
    $btn_type   = '';
    if ($vip_level) {
        //我现在就是会员
        $vip_icon      = zibpay_get_vip_icon($vip_level, 'img-icon', false);
        $vip_exp_date  = get_user_meta($user_id, 'vip_exp_date', true); //到期时间
        $vip_exp_badge = '';
        ...
        if ('permanent' === strtolower($vip_exp_date)) {
            ...
            //永久会员
            $vip_exp_badge = '<span class="badg c-green p2-10 em09">' . zib_get_svg('time', null, 'mr3') . __('永久会员', 'zib_language') . '</span>';
        } else {

            $btn_type = 'renew_' . $vip_level;

            $vip_exp_badge = '<span class="badg c-yellow p2-10 em09">' . zib_get_svg('time', null, 'mr3') . sprintf(__('到期时间：%s', 'zib_language'), date_i18n(__('Y年m月d日', 'zib_language'), strtotime($vip_exp_date))) . '</span>';
        }

        $my_vip_box = '<div class="flex xx gap6">
        <div class="em09 muted-2-color">' . __('我的会员', 'zib_language') . '</div>
        <div class="flex ac">
            <div class="em16 mr10 flex ac">' . $vip_icon . '<div class="font-bold ml6">' . $vip_name[$vip_level] . '</div></div>
            ' . $vip_exp_badge . '
        </div>
        <div class="muted-color em09">' . _pz('vip_opt', __('尊享专属特权', 'zib_language'), 'pay_user_vip_' . $vip_level . '_desc') . '</div>
    </div>';
        ...
        if ($vip_level_expired) {
            ...
            if ('permanent' === strtolower($vip_exp_date)) {
                //永久会员
                $vip_exp_badge = '<span class="badge badge-danger">' . __('已过期', 'zib_language') . '</span>';
            } else {
                $vip_exp_badge = '<span class="badge badge-danger">' . zib_get_svg('time', null, 'mr3') . sprintf(__('过期时间：%s', 'zib_language'), date_i18n(__('Y年m月d日', 'zib_language'), strtotime($vip_exp_date))) . '</span>';
            }

            $my_vip_box = '<div class="flex xx gap6">
            <div class="em09 muted-2-color">' . __('当前会员状态', 'zib_language') . '</div>
            <div class="flex ac">
                <div class="em16 c-red mr10">' . __('已过期', 'zib_language') . '</div>
                <div class="badg c-red em09">' . zib_get_svg('time', null, 'mr3') . sprintf(__('过期时间：%s', 'zib_language'), date_i18n(__('Y年m月d日', 'zib_language'), strtotime($vip_exp_date))) . '</div>
            </div>
            <div class="muted-color em09">' . $pay_user_vip_desc . '</div>
        </div>';
            ...
            <div class="em09 muted-2-color">' . __('当前会员状态', 'zib_language') . '</div>
            <div class="flex ac">
                <div class="em16 c-red mr10">' . __('未开通会员', 'zib_language') . '</div>
            </div>
            <div class="muted-color em09">' . $pay_user_vip_desc . '</div>
        </div>';
        }
    ...
    $my_box = '<div class="zib-widget flex ac gap20 user-content-myvip overflow-hidden">
        <div class="vip-img abs-right">' . $abs_img . '</div>

        <div class="flex2 hide-sm hidden-sm">' . $user_box . '</div><div class="flex4">' . $my_vip_box . '</div>
    </div>';

    $vip_card = '<div class="flex gap20 gap10-sm">' . zibpay_user_page_tab_content_vip_card(1, $btn_type) . zibpay_user_page_tab_content_vip_card(2, $btn_type) . '</div>';
    $html     = $my_box;
    $html .= $vip_card;
    $html .= $vip_level ? '' : zibpay_get_vip_points_exchange_link('', '<div class="c-yellow zib-widget flex ac jsb"><div class="flex1 em12">' . zib_get_svg('points-color', null, 'mr6 em12') . __('积分兑换会员', 'zib_language') . '</div><span class="badg radius c-yellow">' . __('立即兑换', 'zib_language') . '<i class="fa fa-chevron-circle-right ml6"></i></span></div>');
...
function zibpay_user_page_tab_content_vip_card($vip_level = 1, $type = 'pay')
{
    ...
    $btn = '';
    if ('upgrade' == $type && $vip_level > 1) {
        $btn = '<a class="padding-lg but jb-vip' . $vip_level . ' radius pay-vip" href="javascript:;" vip-level="2">' . __('升级', 'zib_language') . $_vip_name . '<span class="ml10"><i class="fa fa-chevron-circle-right"></i></span></a>';
    }

    if ($type === 'pay') {
        $btn = '<a class="padding-lg but jb-vip' . $vip_level . ' radius pay-vip" href="javascript:;" vip-level="' . $vip_level . '">' . __('开通', 'zib_language') . $_vip_name . '<span class="ml10"><i class="fa fa-chevron-circle-right"></i></span></a>';
    }

    if (strpos($type, 'renew') !== false) {
        $_level = str_replace('renew_', '', $type);
        if ($_level <= $vip_level) {
            $_text = $_level >= $vip_level ? __('续费', 'zib_language') : __('升级', 'zib_language');

            $btn = '<a class="padding-lg but jb-vip' . $vip_level . ' radius pay-vip" href="javascript:;" vip-level="' . $vip_level . '">' . $_text . $_vip_name . '<span class="ml10"><i class="fa fa-chevron-circle-right"></i></span></a>';
        }
    }

    $btn = $btn ? '<div class="mt20">' . $btn . '</div>' : '';
    ...
    $html = '<div class="zib-widget text-center pay-vip-info flex1 level-' . $vip_level . '">
        <div class="abs-center vip-baicon">' . $_vip_card_icon . '</div>
        <div class="relative">' . $vip_icon . $vip_equity . $btn . '</div>
    </div>';
...
function zibpay_get_user_pay_statistical($user_id)
{
    ...
    $con .= '<div class="col-md-6">
            <div class="zib-widget" style="padding-left: 24px;">
                <div>
                ' . zib_get_svg('order-color', null, 'em12 mr6') . __('全部订单', 'zib_language') . '
                </div>
                <div class="mt10" style="color: #8080f0;line-height: 1.2;">
                <span class="em3x font-bold mr6">' . $count_all . '</span>' . __('笔', 'zib_language') . '
                </div>
    ...
    $con .= '<div class="col-md-6">
        <div class="zib-widget" style="padding-left: 24px;">
            <div>
            ' . zib_get_svg('money-color', null, 'em12 mr6') . __('支付金额', 'zib_language') . '
            </div>
...
function zibpay_get_user_order($user_id = '', $paged = 1, $ice_perpage = 10)
{
    ...
    if ($db_order['orders']) {
        ...
        $lists .= zib_get_ajax_null(__('暂无订单', 'zib_language'), 40, 'null-order.svg');
    }
...
function zibpay_get_order_details_modal($order)
{
    ...
    if ($status == 0) {
        ...
        if ($time_remaining == 'over') {
            ...
            $time_countdown = '<div class="mt6 em09 muted-2-color">' . __('剩余', 'zib_language') . '<span class="c-yellow badg badg-sm" int-second="1" data-over-text="' . esc_attr(__('1秒', 'zib_language')) . '" data-countdown="' . $time_remaining . '"></span>' . __('自动关闭订单', 'zib_language') . '</div>';
            $header_title   = '<div class="c-yellow mb6 font-bold">' . zib_get_svg('time') . ' ' . __('待支付', 'zib_language') . '</div>' . $time_countdown;
        }
    }
    ...
    if ($status == 0) {
        $footer_right = zibpay_get_order_close_link($order, 'but mr6', __('关闭订单', 'zib_language'));
        $footer_right .= zibpay_get_order_pay_link($order, 'but c-red', __('立即支付', 'zib_language'));

    } elseif ($status == -1) {
        $header_title = '<div class="font-bold">' . __('交易关闭', 'zib_language') . '</div>';
        $header_title .= !empty($order_data['close_reason']) ? '<div class="px12 muted-2-color font-normal">' . $order_data['close_reason'] . '</div>' : '';
    } elseif ($status == 1) {
        $header_title = '<b class="inflex ac"><i class="fa fa-check-circle-o mr6 em12"></i>' . __('交易完成', 'zib_language') . '</b>';
    }
    ...
    $_total_price_type_name     = $status == '1' ? __('实付', 'zib_language') : __('应付', 'zib_language');
    ...
    if (!empty($order_data['prices']['total_discount'])) {
        $info_html .= '<div class="flex ac jsb padding-h6"><div class="flex0 mr6 muted-2-color">' . __('优惠', 'zib_language') . '</div><div class="flex0">-' . $_mark . $order_data['prices']['total_discount'] . '</div></div>';
    }
    ...
    $info_html .= '<div class="flex ac jsb padding-h6"><div class="flex0 mr6 muted-2-color">' . __('订单类型', 'zib_language') . '</div><div class="flex0">' . $order_type_name . '</div></div>';
    $info_html .= '<div class="flex ac jsb padding-h6"><div class="flex0 mr10 muted-2-color">' . __('订单编号', 'zib_language') . '</div><div class="ml20 overflow-hidden flex ac"><div class="text-ellipsis">' . $order['order_num'] . '</div><a href="javascript:;" class="flex flex0 ac copy-text icon-spot" data-clipboard-tag="' . esc_attr(__('订单号', 'zib_language')) . '" data-clipboard-text="' . $order['order_num'] . '">' . __('复制', 'zib_language') . '</a></div></div>';
    $info_html .= '<div class="flex ac jsb padding-h6"><div class="flex0 mr6 muted-2-color">' . __('创建时间', 'zib_language') . '</div><div class="flex0">' . $order['create_time'] . '</div></div>';

    //已经支付
    if ($status == 1) {
        $info_html .= '<div class="flex ac jsb padding-h6"><div class="flex0 mr6 muted-2-color">' . __('支付方式', 'zib_language') . '</div><div class="flex0">' . zibpay_get_order_pay_detail_lists($order) . '</div></div>';
        $info_html .= '<div class="flex ac jsb padding-h6"><div class="flex0 mr10 muted-2-color">' . __('支付单号', 'zib_language') . '</div><div class="ml20 overflow-hidden flex ac"><div class="text-ellipsis">' . $order['pay_num'] . '</div><a href="javascript:;" class="flex flex0 ac copy-text icon-spot" data-clipboard-tag="' . esc_attr(__('支付单号', 'zib_language')) . '" data-clipboard-text="' . $order['pay_num'] . '">' . __('复制', 'zib_language') . '</a></div></div>';
        $info_html .= '<div class="flex ac jsb padding-h6"><div class="flex0 mr6 muted-2-color">' . __('支付时间', 'zib_language') . '</div><div class="flex0">' . $order['pay_time'] . '</div></div>';
        ...
        if ($post_order_expired_option) {
            ...
            if (strtotime($current_time) > strtotime($post_order_expired_option_time)) {
                ...
                $info_html .= '<div class="flex ac jsb padding-h6"><div class="flex0 mr6 muted-2-color">' . __('订单有效期', 'zib_language') . '</div><div class="flex0 c-yellow" data-toggle="tooltip" title="' . esc_attr(__('当前订单已过期，此付费内容需重新购买', 'zib_language')) . '">' . sprintf(__('%s已过期', 'zib_language'), $post_order_expired_option_time) . '</div></div>';
            } else {
                $info_html .= '<div class="flex ac jsb padding-h6"><div class="flex0 mr6 muted-2-color">' . __('订单有效期', 'zib_language') . '</div><div class="flex0" data-toggle="tooltip" title="' . esc_attr(__('到期后此付费内容需重新购买', 'zib_language')) . '">' . $post_order_expired_option_time . '</div></div>';
            }
    ...
    switch ($order_type) {
        ...
        case '6':
            if ($post) {
                $footer_left = '<a href="' . zib_get_user_home_url($post->post_author) . '" class="but">' . __('作者主页', 'zib_language') . '</a>';

                if ($status == 1 && !$post_order_expired_is_over) {
                    $footer_right .= '<a href="' . get_permalink($post) . '" class="but c-blue">' . __('去查看', 'zib_language') . '</a>';
                } elseif ($status == -1 || $post_order_expired_is_over) {
                    $footer_right .= '<a href="' . get_permalink($post) . '" class="but c-blue">' . __('重新购买', 'zib_language') . '</a>';
                }
            }
            break;
        case '11':
        ...
        case '2':
            if ($post) {
                $footer_left = '<a href="' . zib_get_user_home_url($post->post_author) . '" class="but">' . __('作者主页', 'zib_language') . '</a>';
                if ($status == 1 && !$post_order_expired_is_over) {
                    $footer_right .= '<a href="' . get_permalink($post) . '" class="but c-blue">' . __('去下载', 'zib_language') . '</a>';
                } elseif ($status == -1 || $post_order_expired_is_over) {
                    $footer_right .= '<a href="' . get_permalink($post) . '" class="but c-blue">' . __('重新购买', 'zib_language') . '</a>';
                }
            }
        ...
        case '4':
            ...
            if ($status != 0) {
                $footer_right .= '<a href="' . zib_get_user_center_url('vip') . '" class="but c-blue">' . __('我的会员', 'zib_language') . '</a>';
            }
            break;
        ...
        case '8':
            ...
            if ($status != 0) {
                $footer_right .= zibpay_get_balance_charge_link('but c-blue mr6', __('再次充值', 'zib_language'));
                $footer_right .= '<a href="' . zib_get_user_center_url('balance') . '" class="but">' . __('我的余额', 'zib_language') . '</a>';
            }
            break;
        case '9':
            $_img = zib_get_svg('points-color', null, 'muted-box fit-cover c-yellow-2');
            if ($status != 0) {
                $footer_right .= zibpay_get_points_pay_link('but c-blue mr6', __('再次购买', 'zib_language'));
                $footer_right .= '<a href="' . zib_get_user_center_url('balance') . '" class="but">' . __('我的积分', 'zib_language') . '</a>';
            }
            break;
    }
...
function zibpay_get_user_order_list_card_default($order)
{
    ...
    if ($status == '-1') {
        $_status_name = '<span class="c-red">' . __('交易已关闭', 'zib_language') . '</span>';
    }
    ...
    if ($status == '0') {
        ...
        if ($time_remaining == 'over') {
            ...
            $time_remaining = zib_time_to_c($time_remaining);
            $_status_name   = '<span class="c-red">' . __('待支付', 'zib_language') . ' <span class="c-yellow px12 badg badg-sm" int-second="1" max-unit="minute" data-over-text="' . esc_attr(__('交易已关闭', 'zib_language')) . '" data-countdown="' . $time_remaining . '"><span class="minute"></span>:<span class="second"></span></span></span>';
        }
    }

    if ($status == '1') {
        $_status_name = '<span class="c-green">' . __('已支付', 'zib_language') . '</span>';
    }

    if ((int) $status == 0) {
        $_btns = zibpay_get_order_close_link($order, 'but mr6', __('关闭订单', 'zib_language'));
    ...
    switch ($order_type) {
        ...
        case '6':
            if ($post) {
                if ($status == 1 && !$post_order_expired_is_over) {
                    $_btns .= '<a href="' . get_permalink($post) . '" class="but c-blue">' . __('去查看', 'zib_language') . '</a>';
                } elseif ($status == -1 || $post_order_expired_is_over) {
                    $_btns .= '<a href="' . get_permalink($post) . '" class="but c-blue">' . __('重新购买', 'zib_language') . '</a>';
                }
            }
            break;
        case '11':
        ...
        case '2':
            if ($post) {
                if ($status == 1 && !$post_order_expired_is_over) {
                    $_btns .= '<a href="' . get_permalink($post) . '" class="but c-blue">' . __('去下载', 'zib_language') . '</a>';
                } elseif ($status == -1 || $post_order_expired_is_over) {
                    $_btns .= '<a href="' . get_permalink($post) . '" class="but c-blue">' . __('重新购买', 'zib_language') . '</a>';
                }
            }
        ...
        case '4':
            $_img = '<img src="' . zibpay_get_vip_icon_img_url(1) . '" class="radius8 fit-cover vip-card">';
            $_btns .= '<a href="' . zib_get_user_center_url('vip') . '" class="but ml6">' . __('我的会员', 'zib_language') . '</a>';
            break;

        case '8':
            $_img = zib_get_svg('money-color-2', null, 'muted-box fit-cover c-blue-2');
            if ($status != 0) {
                $_btns .= zibpay_get_balance_charge_link('but c-blue mr6', __('再次充值', 'zib_language'));
                $_btns .= '<a href="' . zib_get_user_center_url('balance') . '" class="but">' . __('我的余额', 'zib_language') . '</a>';
            }
            break;
        case '9':
            $_img = zib_get_svg('points-color', null, 'muted-box fit-cover c-yellow-2');
            if ($status != 0) {
                $_btns .= zibpay_get_points_pay_link('but c-blue mr6', __('再次购买', 'zib_language'));
                $_btns .= '<a href="' . zib_get_user_center_url('balance') . '" class="but">' . __('我的积分', 'zib_language') . '</a>';
            }
            break;
...
//获取订单关闭链接
function zibpay_get_order_close_link($order, $class = '', $text = null)
{
    if (null === $text) {
        $text = __('取消订单', 'zib_language');
    }
    $class = $class ? ' ' . $class : '';
    if ($order['status'] != '0') {
        return;
...
//获取订单支付链接
function zibpay_get_order_pay_link($order, $class = '', $text = null)
{
    if (null === $text) {
        $text = __('立即支付', 'zib_language');
    }
    $class = $class ? ' ' . $class : '';
...
function zibpay_get_user_wait_pay_float_window()
{
    ...
    foreach ($wait_pay_orders as $order) {
        ...
        $time_remaining = zib_time_to_c($time_remaining);
        $countdown_html = '<span class="c-yellow px12 countdown-box" int-second="1" max-unit="minute" data-countdown="' . $time_remaining . '" data-over-text="' . esc_attr(__('交易已关闭', 'zib_language')) . '"><span class="minute"></span>:<span class="second"></span></span>';
        $lists .= '
            <div class="flex list-mt10 order-item" data-class="modal-mini full-sm" mobile-bottom="true" data-height="330" data-toggle="RefreshModal" data-action="order_pay_modal&payment_id=' . $order['payment_id'] . '">
                ...
                <div class="flex1">
                    ...
                    <div class="flex jsb ac mt6">' . $countdown_html . '<a class="ml10 but c-red px12 p2-10">' . __('立即支付', 'zib_language') . '</a></div>
                </div>
            </div>
            ';
    }
    ...
    if ($lists) {
        ...
        <text style="font-size: 10px;">' . __('待支付', 'zib_language') . '</text>
        ' . $countdown_html . '
...
function zibpay_user_page_tab_content_order()
{
    ...
    $tabs = array(
        'all'      => array(
            'tab'   => 'all',
            'title' => __('全部', 'zib_language'),
        ),
        'wait-pay' => array(
            'tab'   => 'wait-pay',
            'title' => __('待支付', 'zib_language'),
