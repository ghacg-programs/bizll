...
if (_pz('pay_type_option', true, 'down_verify_nonce') && (!isset($_GET['key']) || !wp_verify_nonce($_GET['key'], 'pay_down'))) {
    zib_die_page(__('环境异常！请重新获取下载链接', 'zib_language'));
}
