...
const poster = (function () {
    ...
    function init(config) {
        ...
        // day
        const $weekarray = [zib__('week_sun'), zib__('week_mon'), zib__('week_tue'), zib__('week_wed'), zib__('week_thu'), zib__('week_fri'), zib__('week_sat')];
        const dayStyle = {
            font: '35px Arial',
            color: 'rgba(255, 255, 255, 1)',
            position: 'left',
        };
        drawOneline($day, dayStyle, zib__('week_prefix') + $weekarray[date.getDay()]);
        ...
        const onload = function () {
            ...
            image.onload = function () {
                ...
                if (config.type === 'product') {
                    ...
                    var unit = config.is_points ? zib__('points') : zib__('currency_yuan');
...
$('body').on('click', '[poster-share]', function () {
    ...
    <div class="flex jc loading-mask absolute main-bg radius8"><div class="loading zts fa-2x"></div><div class="muted-2-color box-body">' + zib__('poster_generating') + '</div>\
    </div>\
    </div>\
    ...
    zib_ajax(
        ...
        function (_poster) {
            poster.init({
                ...
                onerror: function () {
                    notyf(zib__('poster_load_failed'), 'danger');
                },
