 ...
 * @LastEditTime : 2026-05-23 14:22:53
...
(function ($, window) {
    ...
    function _Miniimgbox(img_selector, container_selector, options) {
        ...
        function add_dom() {
            ...
            var button = options.down ? '<a href="javascript:;" download class="img-down toggle-radius mr6" title="' + zib__('imgbox_download') + '"><i class="fa fa-download"></i></a>' : '';
            if (options.group) {
                button += options.play ? '<a href="javascript:;" class="toggle-palay toggle-radius mr6" title="' + zib__('imgbox_play') + '"><i class="fa fa-play"></i></a>' : '';
                if (options.thumbs) {
                    button += '<a href="javascript:;" class="toggle-thumbs toggle-radius mr6" title="' + zib__('imgbox_view_more') + '"><i class="fa fa-th-large"></i></a>';
                    swiper += thumbs_swiper;
                }
            }

            button += options.zoom ? '<a href="javascript:;" class="toggle-zoom toggle-radius mr6" title="' + zib__('imgbox_toggle_zoom') + '"><i class="fa fa-search"></i></a>' : '';
            button += options.full ? '<a href="javascript:;" class="hide-sm toggle-full toggle-radius mr6" title="' + zib__('imgbox_toggle_full') + '"><i class="fa fa-expand"></i></a>' : '';
            button += '<a href="javascript:;" title="' + zib__('close') + '" class="icon-close toggle-radius"><svg viewBox="0 0 1024 1024" class="icon em12"><path d="M573.44 512.128l237.888 237.696a43.328 43.328 0 0 1 0 59.712 43.392 43.392 0 0 1-59.712 0L513.728 571.84 265.856 819.712a44.672 44.672 0 0 1-61.568 0 44.672 44.672 0 0 1 0-61.568L452.16 510.272 214.208 272.448a43.328 43.328 0 0 1 0-59.648 43.392 43.392 0 0 1 59.712 0l237.952 237.76 246.272-246.272a44.672 44.672 0 0 1 61.568 0 44.672 44.672 0 0 1 0 61.568L573.44 512.128z"></path></svg></a>';
