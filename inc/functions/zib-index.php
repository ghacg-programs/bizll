 ...
 * @LastEditTime : 2026-05-24 19:22:19
...
function zib_index_tab_html($nav = 'nav')
{
    ...
    //不是第一页
    if ($paged > 1) {
        return '<div class="box-body notop nobottom"><div class="title-theme">' . ($index_list_title ?: __('最新发布', 'zib_language')) . '<small class="ml10">' . sprintf(__('第%s页', 'zib_language'), $paged) . '</small></div></div>';
    }
    ...
    $html = '<li class="active"><a data-toggle="tab" href="#index-tab-main">' . ($index_list_title ?: __('最新发布', 'zib_language')) . '</a></li>' . $index_tab_nav;
