...
function zib_shop_get_author_contact_link($author_id, $class = 'but', $text = '')
{
    ...
    $text = $text ? $text : '<icon>' . $_svg . '</icon><text>' . __('客服', 'zib_language') . '</text>';
...
function zib_shop_author_main_tab_product($tab = array(), $author_id = 0)
{
    ...
    return array(
        'title'         => __('商品<count class="opacity8 ml3">', 'zib_language') . zib_shop_get_author_product_count($author_id) . '</count>',
