...
function zib_shop_get_order_comment_status_name($comment_status = '')
{
    ...
    $status_name = [
        -1 => __('未开启评论', 'zib_language'),
        0  => __('待评价', 'zib_language'),
        1  => __('已评价', 'zib_language'),
        2  => __('售后中无法评价', 'zib_language'), //售后流程会自动处理
    ];
...
function zib_shop_get_score_average_name_data($score)
{
    ...
    $score_average_name_args = [
        '4.6' => [__('超赞', 'zib_language'), 'c-red'],
        '4'   => [__('很棒', 'zib_language'), 'c-red'],
        '3.5' => [__('不错', 'zib_language'), 'c-yellow'],
        '2.8' => [__('一般', 'zib_language'), ''],
        '2'   => [__('较差', 'zib_language'), ''],
        '0'   => [__('很差', 'zib_language'), ''],
    ];
