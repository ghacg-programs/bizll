 ...
 * @LastEditTime : 2026-05-25 00:24:36
...
function zib_shop_add_shortcode_productbox($atts, $content = null)
{
    ...
    if (!$con && is_super_admin()) {
        $con = '<div class="hidden-box"><div class="text-center">[productbox id="' . $id . '"]</div><div class="hidden-text">' . __('未找到商品，请重新设置短代码商品ID', 'zib_language') . '</div></div>';
    }
    return $con;
}
