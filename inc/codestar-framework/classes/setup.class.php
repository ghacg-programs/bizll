 ...
 * Setup Class
 * 修改了几处内容
 * 1.将register_widgets移出来，挂钩到after_setup_theme
 * 2.去除：   // add_action('after_setup_theme', array('CSF', 'setup'));
    ...
    class CSF
    {
        ...
        public static function init()
        {
         ...
         //   add_action('after_setup_theme', array('CSF', 'setup'));
            add_action('init', array('CSF', 'setup'),1000);
           // add_action('switch_theme', array('CSF', 'setup'));
            ...
            add_action('widgets_init', array('CSF', 'register_widgets'));
        }
