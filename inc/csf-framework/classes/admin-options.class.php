...
if (!class_exists('CSF_Options')) {
  class CSF_Options extends CSF_Abstract
  {
    ...
    public function add_options_html()
    {
      ...
      //额外添加按钮
      echo '<a href="javascript:;" class="csf-menu but hide-box c-red" title="' . esc_attr__('显示选项菜单', 'zib_language') . '"><i class="fas fa-bars"></i></a>';
      echo '</div>';
      ...
      if (!empty($this->args['show_footer'])) {
        ...
        echo '<a href="javascript:;" class="csf-menu but hide-box c-yellow" title="' . esc_attr__('显示选项菜单', 'zib_language') . '"><i class="fas fa-bars"></i></a>';
        echo '</div>';
